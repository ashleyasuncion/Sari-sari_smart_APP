...
import com.example.sari_sari_smart.MainActivity
import com.example.sari_sari_smart.R
...
object NotificationDeepLinks {
    const val MORNING = "sarisarismart://morning"        // overdue store
    const val INVENTORY = "sarisarismart://inventory"    // stock / restock
    const val CLOSING = "sarisarismart://closing"        // closing reminder
    const val DEBTS = "sarisarismart://debts"            // weekly digest
}
...
object NotificationCenter {
    ...
    fun post(
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(R.drawable.ic_stat_sari)
